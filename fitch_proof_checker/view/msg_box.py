...
def setup_msg_box(fpe_main_window):
    ...
    fpe_main_window.log_console.setStyleSheet("background-color: #f5f5f5; color: #8b0000; font-family: monospace;")
    fpe_main_window.log_console.setPlaceholderText("No error found.")
